...
#ifndef SparkFun_APDS9960_I2C_H
#define SparkFun_APDS9960_I2C_H
...
/* APDS9960 Class */
class SparkFun_APDS9960_SoftwareWire {
public:

    /* Initialization methods */
	SparkFun_APDS9960_SoftwareWire();
    ~SparkFun_APDS9960_SoftwareWire();

    bool init(unsigned char port_sda, unsigned char port_scl);
