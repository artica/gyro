/*
 ...
 Motoruino 2 Protocol Command Definitions with Slave microcontroller

 V0.0 - Serras and Tarquinio - 23/11/2015
 	 Protocol Command Definitions with Slave microcontroller
...
#ifndef _MOTORUINO2PROTOCOL_H_
#define _MOTORUINO2PROTOCOL_H_
#define CMD_SIZE	1
...
enum _ProcessLaterOrders {
	...
	REPLY_GET_ADC_MOTOR, REPLY_SET_ADC_MOTOR
};
